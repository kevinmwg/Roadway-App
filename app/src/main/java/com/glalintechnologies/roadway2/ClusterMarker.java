...
public class ClusterMarker implements ClusterItem {
    ...
    // Method to update marker details dynamically
    public void updateMarkerDetails(LatLng newPosition, String newTitle, String newSnippet, int newIconResId) {
        setPosition(newPosition);
        setTitle(newTitle);
        setSnippet(newSnippet);
        setIcon(newIconResId);
    }

    // Custom view for the marker
    public View getMarkerView() {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.custom_marker_view, null);
        ...
        ImageView iconView = view.findViewById(R.id.excavator2);

        titleView.setText(title);
        snippetView.setText(snippet);

        // Ensure the marker image matches your layout's expected image
        iconView.setImageResource(R.drawable.pickup2); // Replace with your icon resource
